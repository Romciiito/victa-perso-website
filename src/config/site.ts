...
export const site = {
  ...
  // No `ogImage` field — the OG/Twitter preview image is generated by the
  // Next.js file convention at `src/app/opengraph-image.tsx`, which has its
  // own URL and is auto-injected into metadata (audit P1-03). A separate
  // static field here previously pointed at a file that was never created.
