...
### Vlna 2b — EN parita (vize §10; startuje až po schválení finálního CS copy)
Doplnění 194 leaf klíčů do content/en/strings/common.json · odstranění `<EnglishStub>` (předpoklad: i18n migrace z Vlny 2 hotová) · hreflang cs+en až po paritě. **Neblokuje Fázi 3 ani launch** — do parity zůstávají EN routy noindex + mimo sitemap (P0-19 řešen ve Vlně 0).
